...
No account needed. No data stored. Works in your browser.
...
**Q: Is my data safe?**
A: Yes. Data is held in your browser session only. Nothing is written to disk or transmitted outside normal Streamlit operation. Refreshing the page clears everything.

**Q: Can I use this with real student names?**
A: Yes, but we recommend anonymous labels (`Student 1, Student 2, ...`) as a best practice. If you upload a CSV with a name column, that column is preserved in outputs but never leaves your browser.
